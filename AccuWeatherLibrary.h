...
enum AccuParserTokens_ {
  ...
  ACCUPARSERGMTOffset,
  ACCUPARSERTimezone,
  ACCUPARSERIsDaylightSavings,
  ACCUPARSERCode,
  ACCUPARSERName,
  ACCUPARSERLocalizedName,
  ACCUPARSERPostalCode,
  ACCUPARSERGeoPosition,
  ACCUPARSERLatitude,
  ACCUPARSERLongitude,
};
...
class AccuweatherLocationParser: public AccuweatherParser {
  public:
    AccuweatherLocationParser(AccuweatherLocationData* data_ptr_);
    virtual void value(String value);
  protected:
    AccuweatherLocationData* data_ptr;
};
